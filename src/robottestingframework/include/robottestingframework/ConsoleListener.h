...
#ifndef ROBOTTESTINGFRAMEWORK_CONSOLELISTENER_H
#define ROBOTTESTINGFRAMEWORK_CONSOLELISTENER_H
 ...
 */
class ConsoleListener : public TestListener
{
public:
    /**
...
#endif // ROBOTTESTINGFRAMEWORK_CONSOLELISTENER_H
