...
#ifndef ROBOTTESTINGFRAMEWORK_LUAPLUGINLOADER_H
#define ROBOTTESTINGFRAMEWORK_LUAPLUGINLOADER_H
 ...
 */
class LuaPluginLoader : public PluginLoader
{
public:
    /**
...
#endif // ROBOTTESTINGFRAMEWORK_LUAPLUGINLOADER_H
